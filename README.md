...
1. Install the camera hamoa firmware package:
    - `sudo dpkg -i camx-firmware-talos_<version>_arm64.deb`
...
pkg-camx-firmware-talos is licensed under the [BSD-3-Clause license](https://spdx.org/licenses/BSD-3-Clause.html). See [LICENSE.txt](LICENSE.txt) for the full license text.
